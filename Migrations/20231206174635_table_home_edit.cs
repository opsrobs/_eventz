...
namespace eventz.Migrations
{
    public partial class table_home_edit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventDescription = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThisLocalizationId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Event_Localization_ThisLocalizationId",
                        column: x => x.ThisLocalizationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_ThisLocalizationId",
                table: "Event",
                column: "ThisLocalizationId");
